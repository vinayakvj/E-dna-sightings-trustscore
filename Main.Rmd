...
get_aus_box_fast <- function() {
  message("ðŸŒ Using rough Australia bbox fallback.")
...
# 1) Builds an â€œArea of Interestâ€ (AOI) around your sampling sites in Australia
...
###############################################################################
# 1ï¸âƒ£  DEFINE AREA OF INTEREST (AOI)
# ----------------------------------------------------------------------------
...
# Turn your rows into spatial points if you donâ€™t already have `pts_in_aus`.
...
# Build hull â†’ buffer â†’ convert back to WGS84 (lon/lat) â†’ export as WKT text.
...
###############################################################################
# 3ï¸âƒ£  EXTRACT CANDIDATE SPECIES NAMES (binomials only)
# ----------------------------------------------------------------------------
...
###############################################################################
# 4ï¸âƒ£  RESOLVE WORMS APHIAID + FETCH OBIS RECORDS (with caching)
# ----------------------------------------------------------------------------
...
###############################################################################
# 5ï¸âƒ£  BUILD SPECIES LIST + LIGHTWEIGHT INDEX
# ----------------------------------------------------------------------------
...
###############################################################################
#  7ï¸âƒ£  SUMMARIES: OVERALL + PER-SPECIES QUANTILES
# ----------------------------------------------------------------------------
...
###############################################################################
# 8ï¸âƒ£  SAVE OUTPUTS + LIGHT DIAGNOSTICS
# ----------------------------------------------------------------------------
